...
/**
 * Sequelize model — `jockey_assignment_contracts` table.
 */

module.exports = (sequelize, DataTypes) => {
    const JockeyAssignmentContract = sequelize.define(
        ...
        { tableName: 'jockey_assignment_contracts' }
    );

    JockeyAssignmentContract.associate = (models) => {
        JockeyAssignmentContract.belongsTo(models.JockeyAssignment, { foreignKey: 'assignment_id', as: 'assignment' });
    };

    return JockeyAssignmentContract;
};
